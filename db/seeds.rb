...
@post2 = @user.posts.create!(title: "Dream Stream Cuttbow", description: "Cuttbow Wd-40 action", city: "Fairplay", state: "CO", fly_or_conventional: "Fly", body_of_water: "Dream Stream", region: 'South Park', privacy: "Public")
